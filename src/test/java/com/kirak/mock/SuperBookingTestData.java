 ...
 */
public class SuperBookingTestData {

    public static final ModelMatcher<SuperBooking> SUPER_BOOKING_MATCHER = ModelMatcher.of(SuperBooking.class);
    ...
    public static final SuperBooking SUPER_BOOKING3 = new SuperBooking(SUPER_BOOKING3_ID, true,
            of(2017, Month.MARCH, 8, 19, 25), (short)0, 3200.00, (short)2, USER3, HOTEL2,
            "Name3", "email3@gmail.com", "384367654822");
    public static final SuperBooking SUPER_BOOKING4 = new SuperBooking(SUPER_BOOKING4_ID, true,
            of(2017, Month.MAY, 2, 10, 43), (short)0, 10000.00, (short)2, USER1, HOTEL3,
            "Name4", "emai41@gmail.com", "3842344822");
    public static final SuperBooking SUPER_BOOKING5 = new SuperBooking(SUPER_BOOKING5_ID, false,
            of(2017, Month.FEBRUARY, 15, 16, 35), (short)0, 31200.00, (short)2, ADMIN, HOTEL4,
            "Name5", "email5@gmail.com", "384376754822");


    public static final List<SuperBooking> SUPER_BOOKINGS = Arrays.asList(SUPER_BOOKING1, SUPER_BOOKING4, SUPER_BOOKING3,
            SUPER_BOOKING5, SUPER_BOOKING2);


    public static SuperBooking getCreatedSuperBooking() {
        return new SuperBooking(null, true,
                of(2016, Month.JULY, 18, 16, 16), (short)0, 6000.00, (short)1, USER1, HOTEL1,
                "Namekksef", "emailsefe@gmail.com", "384522224822");
    }

    public static SuperBooking getUpdatedSuperBooking() {
        return new SuperBooking(SUPER_BOOKING1_ID, true,
