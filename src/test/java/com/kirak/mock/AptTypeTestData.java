...
public class AptTypeTestData {
    ...
    public static final AptType TYPE1 = new AptType(TYPE1_ID, "ARRANGEMENT1", "STANDARD", (short) 1);
    public static final AptType TYPE2 = new AptType(TYPE2_ID, "ARRANGEMENT2", "STANDARD", (short) 2);
    public static final AptType TYPE3 = new AptType(TYPE3_ID, "ARRANGEMENT3", "SUPERIOR", (short) 2);
    public static final AptType TYPE4 = new AptType(TYPE4_ID, "ARRANGEMENT4", "COMFORT", (short) 2);
    public static final AptType TYPE5 = new AptType(TYPE5_ID, "ARRANGEMENT5", "FAMILY", (short) 4);


    public static AptType getCreated() {
