...
public class CityTestData {
    ...
    public static final City MOSCOW = new City(MOSCOW_ID, "Moscow", "Moscow Description", RUSSIA);
    public static final City ST_PETERSBURG = new City(SPB_ID, "St Petersburg", "St Petersburg Description", RUSSIA);
    public static final City KYIV = new City(KYIV_ID, "Kiev", "Kiev Description", UKRAINE);
    public static final City LVIV = new City(LVIV_ID, "Lviv", "Lviv Description", UKRAINE);
