...
<script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/dt_manager/hotelVotesDatatable.js" defer></script>
                ...
                <div class="col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-body" style="padding: 10px;">
                            <h4 class="pull-left"><strong><spring:message code="common.obj_votes_list"/> #${objectId}:</strong></h4>
                        </div>
                    </div>
                </div>
            </div>
